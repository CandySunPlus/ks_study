...
The system SHALL display a grid of all questions in the current practice/review session, with each question showing its status through color coding and icons.
